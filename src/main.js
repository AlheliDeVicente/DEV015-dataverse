...
classSelector.addEventListener("change", () => { //evento change registra cambios en la selección//
  const classSelected = classSelector.value;
  filteredData = filterData(data, "classification", classSelected);
  return renderItems(filteredData);
});
...
statsButton.addEventListener("click", ()=>{
  ...
  statsParagraphs.innerHTML =
  `Hay un promedio de ${computedStats}% mujeres filosofas` 
